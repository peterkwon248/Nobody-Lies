...
function statementRequest(c) {
  ...
  const 보충 = [
    ...
    /**
     * ⚠ **여기 「길이 균일」이라고 적혀 있었다** (2026-07-30 오후 고침).
     *
     * 서식 본문의 *"길이도 온도의 일부"* 와 **같은 값 두 곳**이었고, 둘이 같이
     * 밀어서 첫 완성본이 최장/최단 **1.17배**로 나왔다(산장은 2.46배). 그런데
     * 기계가 보는 것은 **문단 수**뿐이다(§9-9) — 글자 수는 한 번도 안 본다.
     * 서식만 고치고 여기를 안 고치면 얇은 쪽이 또 이긴다(07-30 오전에 문단 수
     * 규격으로 정확히 그랬다).
     */
